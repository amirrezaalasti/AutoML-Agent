...
def get_configspace():
    ...
    cs.add_hyperparameters([learning_rate, eta0, max_iter, tol, early_stopping, validation_fraction, n_jobs, random_state, warm_start, epsilon, shuffle, verbose, max_fun])
