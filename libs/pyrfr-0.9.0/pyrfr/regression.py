...
class num_num_pair_vector(object):
    ...
    def __nonzero__(self):
        return _regression.num_num_pair_vector___nonzero__(self)

    def __bool__(self):
        return _regression.num_num_pair_vector___bool__(self)

    def __len__(self):
        return _regression.num_num_pair_vector___len__(self)

    def __getslice__(self, i, j):
        return _regression.num_num_pair_vector___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _regression.num_num_pair_vector___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _regression.num_num_pair_vector___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _regression.num_num_pair_vector___delitem__(self, *args)

    def __getitem__(self, *args):
        return _regression.num_num_pair_vector___getitem__(self, *args)

    def __setitem__(self, *args):
        return _regression.num_num_pair_vector___setitem__(self, *args)

    def pop(self):
        return _regression.num_num_pair_vector_pop(self)

    def append(self, x):
        return _regression.num_num_pair_vector_append(self, x)

    def empty(self):
        return _regression.num_num_pair_vector_empty(self)

    def size(self):
        return _regression.num_num_pair_vector_size(self)

    def swap(self, v):
        return _regression.num_num_pair_vector_swap(self, v)

    def begin(self):
        return _regression.num_num_pair_vector_begin(self)

    def end(self):
        return _regression.num_num_pair_vector_end(self)

    def rbegin(self):
        return _regression.num_num_pair_vector_rbegin(self)

    def rend(self):
        return _regression.num_num_pair_vector_rend(self)

    def clear(self):
        return _regression.num_num_pair_vector_clear(self)

    def get_allocator(self):
        return _regression.num_num_pair_vector_get_allocator(self)

    def pop_back(self):
        return _regression.num_num_pair_vector_pop_back(self)
    ...
    def front(self):
        return _regression.num_num_pair_vector_front(self)

    def back(self):
        return _regression.num_num_pair_vector_back(self)

    def assign(self, n, x):
        return _regression.num_num_pair_vector_assign(self, n, x)

    def resize(self, *args):
        return _regression.num_num_pair_vector_resize(self, *args)

    def insert(self, *args):
        return _regression.num_num_pair_vector_insert(self, *args)

    def reserve(self, n):
        return _regression.num_num_pair_vector_reserve(self, n)
...
class binary_rss_vectors(object):
    ...
    def __nonzero__(self):
        return _regression.binary_rss_vectors___nonzero__(self)

    def __bool__(self):
        return _regression.binary_rss_vectors___bool__(self)

    def __len__(self):
        return _regression.binary_rss_vectors___len__(self)

    def __getslice__(self, i, j):
        return _regression.binary_rss_vectors___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _regression.binary_rss_vectors___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _regression.binary_rss_vectors___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _regression.binary_rss_vectors___delitem__(self, *args)

    def __getitem__(self, *args):
        return _regression.binary_rss_vectors___getitem__(self, *args)

    def __setitem__(self, *args):
        return _regression.binary_rss_vectors___setitem__(self, *args)

    def pop(self):
        return _regression.binary_rss_vectors_pop(self)

    def append(self, x):
        return _regression.binary_rss_vectors_append(self, x)

    def empty(self):
        return _regression.binary_rss_vectors_empty(self)

    def size(self):
        return _regression.binary_rss_vectors_size(self)

    def swap(self, v):
        return _regression.binary_rss_vectors_swap(self, v)

    def begin(self):
        return _regression.binary_rss_vectors_begin(self)

    def end(self):
        return _regression.binary_rss_vectors_end(self)

    def rbegin(self):
        return _regression.binary_rss_vectors_rbegin(self)

    def rend(self):
        return _regression.binary_rss_vectors_rend(self)

    def clear(self):
        return _regression.binary_rss_vectors_clear(self)

    def get_allocator(self):
        return _regression.binary_rss_vectors_get_allocator(self)

    def pop_back(self):
        return _regression.binary_rss_vectors_pop_back(self)
    ...
    def front(self):
        return _regression.binary_rss_vectors_front(self)

    def back(self):
        return _regression.binary_rss_vectors_back(self)

    def assign(self, n, x):
        return _regression.binary_rss_vectors_assign(self, n, x)

    def resize(self, *args):
        return _regression.binary_rss_vectors_resize(self, *args)

    def insert(self, *args):
        return _regression.binary_rss_vectors_insert(self, *args)

    def reserve(self, n):
        return _regression.binary_rss_vectors_reserve(self, n)
...
class binary_rss_forest(object):
    ...
    * `options` : `forest_options< num_t, response_t, index_t >`  
    ...
    def predict_marginalized_over_instances(self, feature_matrix, log_y=False):
        r"""
